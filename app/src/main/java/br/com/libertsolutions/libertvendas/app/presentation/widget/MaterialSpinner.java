...
public class MaterialSpinner extends AppCompatSpinner
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        arrowSize = array.getDimension(
                R.styleable.MaterialSpinner_ms_arrowSize, dpToPx(context, DEFAULT_ARROW_WIDTH_DP));
    ...
    @Override public void setSelection(final int position) {
        this.post(() -> MaterialSpinner.super.setSelection(position));
    }
    ...
    @Override protected void onDraw(Canvas canvas) {
        ...
        if (error != null && enableErrorLabel) {
            lineHeight = dpToPx(getContext(), thicknessError);
            ...
            lineHeight = dpToPx(getContext(), thickness);
        ...
        drawSelector(canvas, getWidth() - rightLeftSpinnerPadding, getPaddingTop() + dpToPx(getContext(), 8));
    }
